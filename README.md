...
# Vamos aos Jogos:
A instalação dos Jogos é um processo super simples. Porém, mesmo assim, algumas pessoas precisam de alguma orientação, talvez essa pessoa possa ser você. Para aprender a ![instalar qualquer jogo do PlayOnGit: clique Aqui!](https://raw.githubusercontent.com/felipefacundes/dicas/master/instalar.md)
